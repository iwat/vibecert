...
type CreateCertificateParams struct {
	...
	SubjectKeyID   string
	AuthorityKeyID sql.NullString
	IsCA           int64
	PEMData        string
	PublicKeyHash  string
}

func (q *Queries) CreateCertificate(ctx context.Context, arg CreateCertificateParams) (domain.Certificate, error) {
...
func (q *Queries) CreateKey(ctx context.Context, arg CreateKeyParams) (domain.KeyPair, error) {
...
func (q *Queries) KeyByID(ctx context.Context, id int64) (domain.KeyPair, error) {
